#' Obtain the Chromium data
#'
#' Obtain the Chromium data from the Xenium preprint Janesick \emph{et al.}(2022).
#'
#' @details
#'
#' Chromium `Feature / cell matrix HDF5 (per-sample)` .h5 file was downloaded from the FRP tab 
...
get_xeniumpreprint_chromium_sce <- function(){
  # sce <- .create_sce(file.path("chromium"), has.rowdata=FALSE)
  # 
  # sce
}